 ...
 * @param {Number} id_applications_source Flow id_applications_source
 */
exports.findByIdApplicationsSource = async function (id_applications_source) {
    try {
        if (isNaN(id_applications_source)) {
            throw new exception.httpException('This param : id_applications_source, is not a number.', 400);
        }
        return await flows_repository.findByIdApplicationsSource(id_applications_source);
    } catch (error) {
        log.error('Service', 'Flows', 'findByIdApplicationsSource', error);
        throw error;
    }
}
 ...
 * @param {Number} id_applications_target Flow id_applications_target
 */
exports.findByIdApplicationsTarget = async function (id_applications_target) {
    try {
        if (isNaN(id_applications_target)) {
            throw new exception.httpException('This param : id_applications_target, is not a number.', 400);
        }
        return await flows_repository.findByIdApplicationsSource(id_applications_target);
    } catch (error) {
        log.error('Service', 'Flows', 'findByIdApplicationsTarget', error);
        throw error;
    }
}
...
exports.add = async function (name, description, id_applications_source, id_applications_target) {
    try {
        ...
        if (_.isEmpty(description)) {
            throw new exception.httpException('This param : description, is empty or null.', 400);
        }
        ...
        if (isNaN(id_applications_source)) {
            throw new exception.httpException('This param : id_applications_source, is not number.', 400);
        }

        if (isNaN(id_applications_target)) {
            throw new exception.httpException('This param : id_applications_target, is not number.', 400);
        }
...
exports.deleteById = async function (id) {
    try {
        ...
        if (_.isEmpty(flow[0])) {
            throw new exception.httpException('A flow whith this id not exists.', 400);
        }
